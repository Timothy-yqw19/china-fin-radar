...
STOPWORDS = set(
    ["的", "了", "和", "与", "及", "或", "在", "是", "为", "对", "中", "上", "下", "有", "将", "把", "被", "等", "就", "也", "并", "而", "从", "到", "由", "以", "其", "该", "各", "个", "我们", "他们", "表示", "指出", "认为", "强调", "要求", "提出", "进一步", "加大", "加快", "推动", "支持", "促进", "完善", "加强", "有关", "方面", "情况", "问题", "工作", "相关", "目前", "记者", "报道", "消息", "今日", "昨日", "今天", "昨天", "上午", "下午", "发布", "举行", "持续", "有效", "积极", "稳定", "增长", "下降", "亿元", "万元", "同比", "环比", "以上", "以下", "之间", "一步", "重要", "主要", "通过", "新华社", "证券时报", "中国证券报", "上海证券报", "财联社", "央视", "记者", "表示", "当地时间", "央视新闻", "同比增长", "环比增长", "亿美元", "亿元人民币", "月以来", "月份以来", "据统计", "数据显示", "国家统计局", "有关部门", "相关人士", "业内人士", "分析师", "研究员", "编辑", "责任编辑", "免责声明", "风险提示", "更多精彩", "点击查看", "详细内容", "全文如下", "具体情况", "有关情况", "年度报告", "季度报告", "日报", "周报", "月报", "早报", "早餐", "快讯", "电报", "直播", "会议", "通知", "公告", "活动", "发布会", "新闻", "消息", "报道", "举行", "召开", "出席", "参加", "拜访", "会见", "洽谈", "签约", "落地", "上线", "完成", "实现", "达到", "超过", "突破", "触及", "关于", "根据", "按照", "位于", "属于", "包括", "包含", "涉及", "影响", "预计", "有望", "可能", "或将", "已经", "正在", "将继续", "第一", "第二", "第三", "第四", "第五", "之一", "之二", "方面", "领域", "行业", "企业", "公司", "机构", "部门", "地区", "城市", "领导", "同志", "主席", "总裁", "董事", "高管", "经理", "总监", "首席", "专家", "学者", "教授", "院长", "主任", "局长", "部长", "据报道", "据新华社", "的消息", "的通知", "的规定", "的有关", "的公告", "的意见", "本次", "同比", "环比", "百分点", "今年以来", "去年以来", "现报", "美元", "港元", "人民币", "消息人士", "有关负责人", "自治区", "直辖市", "省份", "有关负责", "有关事", "关负责", "关问题", "有关事项", "局有关", "行有关", "发展有关", "联合印发", "贯彻落实", "金管理", "业保险", "行行长", "行发布", "保基金", "金融支持", "投资基金", "印发", "发布", "方案", "指导意见", "实施方案", "党中央", "国务院", "中国人民银行", "中国证监会", "金融监管总局", "国家外汇管理局"]
)
